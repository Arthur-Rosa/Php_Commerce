    ...
    <div class="bar-lateral">
        <div class="content-bar">
            ...
            <div class="escolhas-bar">
                <div class="sch">
                    <a href="FuncPedidos.php" target="_blank"><i class="fas fa-mail-bulk"
    ...
    <div class="body">
        ...
        <div class="conteudo-body">
            ...
            <div class="bg-progress">
                ...
                <div class="group-btn">
                    <hr>
                    <button class="btn btnall btnwar" onclick="window.location.href='FuncPedidos.php'">VOLTAR</button>
                    <button class="btn btnall btndwd" onclick="window.location.href='FuncDown.php'">BAIXAR
                        ARQUIVO</button>
                ...
                <div class="responsavel-inpt">
                    <form method="get">
                        ...
                        <input type="text" name="responsavel" placeholder="Digite seu nome" maxlength="50" value="<?php
                            $_SESSION['status_pedido'] = $pedido; 
                        if ($resp != null) {echo $resp;} else {} ?>"
                            <?php if($pedido == 3 || $pedido == 4){echo 'disabled=""';}?> required>
                        <hr>
                        <?php if ($_SESSION['status_pedido'] == 2) {
                                    echo '
                        <a href="FuncProducao.php?func=puxar&id=">
                        ...
                        if ($_SESSION['status_pedido'] == 1) {
                                    echo '
                    <a href="FuncProducao.php?func=true">
                        <button class="btn btnall btn-success">INICIAR PRODUÇÃO</button></a>
                        <?php ';
                                }
                                
                                // action="FuncProducao.php?func=puxar" 
                                // onclick="window.location.href='.$resp.'"
                                // <?php if($resp != null){echo 'disabled="a"';} else {} ?>
                    </form>
                </div>
            </div>
        </div>
...
<?php
if (@$_GET['responsavel'] != null) {
    $id = $_SESSION['id_pedido'];
    $responsavel = $_GET['responsavel'];
    $responsavel = preg_replace('/[^[:alnum:]_]/', '', $responsavel);
    ...
    if ($pedido == 1){
        ...
        echo "<script>alert('Producao Iniciada !');location.href=\"FuncProducao.php\";</script>";
        ...
        if ($action) {
            echo "<script>alert('Pedido enviado com sucesso !');location.href=\"FuncProducao.php\";</script>";
        } else {
        }
    } 
} else {
    // Header('Location: FuncPedidos.php');
}
