    ...
    <div class="body">
        ...
        <div class="conteudo-body">
            ...
            <div class="ped-producao">
                ...
                $query = "SELECT id,status_pedido,id_usuario,nome_usuario FROM pedidos WHERE id_usuario = '" . $_SESSION['id'] . "' AND status_pedido = 4 LIMIT $inicio, $quantidade ";
                ...
                $sqlTotal   = "SELECT id FROM pedidos  WHERE id_usuario = '" . $_SESSION['id'] . "' AND status_pedido = 4 ";
                //Executa o SQL
