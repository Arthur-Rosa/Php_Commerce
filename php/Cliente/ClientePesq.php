    ...
    <div class="body">
        ...
        <div class="conteudo-body">
            ...
            <div class="ped-producao">
                ...
                <?php
                include_once('../conexao.php');
                $conteudo = $_SESSION['pesq'];
                $query = "SELECT id,status_pedido,id_usuario,nome_usuario FROM pedidos WHERE id_usuario = '" . $_SESSION['id'] . "' AND id LIKE '%$conteudo%' LIMIT $inicio, $quantidade ";
                ...
                <div class="pedido-card <?php if ($pedido == 1) {
                    ...
                    onclick="window.location.href='ClientePedidos.php?func=puxar&id=<?php echo $value['id']; ?>'">
                ...
                $sqlTotal   = "SELECT id FROM pedidos WHERE id_usuario = '" . $_SESSION['id'] . "' AND id LIKE '%$conteudo%'";
                //Executa o SQL
