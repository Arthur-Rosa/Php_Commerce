        ...
        <div class="conteudo-body">
            ...
            <div class="bg-table">
                <table class="table table-responsive table-action">
                    ...
                    $query = "SELECT * FROM usuarios WHERE nome_usuario LIKE '%$pesquisar%' LIMIT $inicio, $quantidade";
                    ...
                    <?php }
                        ...
                        echo '<span class="text-muted">Nenhum dado encontrado';
                    }
                 ?>
                    <tfoot>
                        <tr>
...
$sqlTotal   = "SELECT * FROM usuarios WHERE nome_usuario LIKE '%$pesquisar%' ";
//Executa o SQL
