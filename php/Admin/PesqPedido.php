...
if (@$_GET['num'] == '1') {
    header('Location: AdminPedidosOnly1.php');
}

if (@$_GET['num'] == '2') {
    header('Location: AdminPedidosOnly2.php');
}

if (@$_GET['num'] == '3') {
    header('Location: AdminPedidosOnly3.php');
}

if (@$_GET['num'] == '4') {
    header('Location: AdminPedidosOnly4.php');
}
...
if(@$_GET['pesquisar'] != null){
    ...
    echo "<script> window.location.href = 'PesqPedido.php?';</script>";
}
    ...
    <div class="bar-lateral">
        <div class="content-bar">
            ...
            <div class="escolhas-bar">
                <div class="sch">
                    <!-- <img src="images/Rectangle 13.png" class="sch-img"> --><a href="AdminPedidos.php"
                        target="_blank"><i class="fas fa-mail-bulk" style="font-size: 20px;"></i><span>
                            PEDIDOS</span></a>
                </div>
                <div class="sch">
                    <!-- <img src="images/Rectangle 13.png" class="sch-img"> --><a href="AdminUsers.php"
                        target="_blank"><span><i class="fas fa-users" style="font-size: 20px;"></i> USUÁRIOS</span></a>
                </div>
                <div class="sch">
                    <!-- <img src="images/Rectangle 13.png" class="sch-img"> --><a href="AdminBackup.php"
                        target="_blank"><span><i class="fas fa-database" style="font-size: 20px;"></i> BACKUP</span></a>
                </div>
                <div class="sch">
    ...
    <div class="body">
        ...
        <div class="conteudo-body">
            <div class="card-group-card">
                ...
                <div class="cardD card-aberto" onclick="window.location.href='AdminPedidos.php?num=1'">
                ...
                <div class="cardD card-engr" onclick="window.location.href='AdminPedidos.php?num=2'">
                    <div class="content-card-top">
                        <div class="img-card">
                ...
                <div class="cardD card-envelope" onclick="window.location.href='AdminPedidos.php?num=3'">
                    <div class="content-card-top">
                        <div class="img-card">
                ...
                <div class="cardD card-coin" onclick="window.location.href='AdminPedidos.php?num=4'">
                    <div class="content-card-top">
                        <div class="img-card">
            ...
            <div class="ped-producao">
                ...
                $pesquisar = $_SESSION['pesq'];
                $pesquisar = preg_replace('/[^[:alnum:]_]/', '', $pesquisar);
                
                $query = "SELECT id,status_pedido,id_usuario,nome_usuario FROM pedidos WHERE id LIKE '%$pesquisar%' LIMIT $inicio, $quantidade ";
                ...
                <div class="pedido-card <?php if ($pedido == 1) {
                    ...
                    <div class="content-pedido">
                        ...
                        <div class="button-producao">
                            <a href="AdminPedidos.php?func=puxar&id=<?php echo $value['id']; ?>">
                ...
                $sqlTotal   = "SELECT id FROM pedidos";
                //Executa o SQL
